...
This is a quick reference for how to connect to the Dino Islander server from a browser or Node.js client using the Colyseus client library.
...
You'll use the [Colyseus Unity SDK](https://github.com/colyseus/colyseus-unity):
